...
namespace Deliver.Web.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BmlAccount = table.Column<string>(nullable: true),
                    MibAccount = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedUserId = table.Column<int>(nullable: true),
                    IsActive = table.Column<bool>(nullable: false),
                    IslandId = table.Column<int>(nullable: false),
                    UserId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IslandShop", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IslandShop_Islands_IslandId",
                        column: x => x.IslandId,
                        principalTable: "Islands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IslandShop_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IslandId = table.Column<int>(nullable: false),
                    PhoneNumber = table.Column<string>(maxLength: 7, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Islands_IslandId",
                        column: x => x.IslandId,
                        principalTable: "Islands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IslandShop_IslandId",
                table: "IslandShop",
                column: "IslandId");

            migrationBuilder.CreateIndex(
                name: "IX_IslandShop_UserId",
                table: "IslandShop",
                column: "UserId");
