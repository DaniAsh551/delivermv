    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var userName = await _db.Users.Where(x => x.IsActive && x.PhoneNumber == Input.Phone)
        ...
        //public async Task<IActionResult> OnPostSendVerificationMobileAsync()
        //{
        //    if (!ModelState.IsValid)
        //    {
        //        return Page();
        ...
        //    var userId = await _db.Users.Where(x => x.IsActive && x.PhoneNumber == Input.Phone)
